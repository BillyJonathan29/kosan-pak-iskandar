...
<div class="container-fluid px-4 pb-4">
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dt class="col-sm-4 text-muted fw-normal">Tagihan Bulan Ke</dt>
                        <dd class="col-sm-8 fw-semibold">
                            Bulan <?= htmlspecialchars($payment['billing_month'] ?? '1') ?>
                        </dd>

                        <dt class="col-sm-4 text-muted fw-normal">Jatuh Tempo</dt>
                        <dd class="col-sm-8 text-danger fw-semibold">
                            <?= !empty($payment['due_date']) ? date('d M Y', strtotime($payment['due_date'])) : '—' ?>
                        </dd>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <dl class="row mb-0 small">
                        ...
                        <dd class="col-7">
                            <?= (!empty($payment['booking_date']) && !empty($payment['duration']))
                                ? date('d M Y', strtotime("+" . $payment['duration'] . " months", strtotime($payment['booking_date'])))
                                : '—' ?>
                        </dd>
    ...
    <div class="mt-4 d-flex gap-2">
        <a href="<?= BASEURL ?>/transaction" class="btn btn-outline-secondary rounded-pill">
            <i class="fas fa-arrow-left me-2"></i>Kembali
        </a>
        
        <?php if ($payment['payment_status'] !== 'paid'): ?>
        <a href="<?= BASEURL ?>/transaction/checkStatus/<?= $payment['id'] ?>" class="btn btn-primary rounded-pill">
            <i class="fas fa-sync-alt me-2"></i>Cek Status ke Midtrans
        </a>
        <?php endif; ?>
    </div>
